...
const translations = {
  ...
  my: {
    ...
    "services.desc":
      "သင့်အတွက် လိုအပ်သော ui/ux ဝန်ဆောင်မှု အမျိုးအစားအားလုံးကို သင့်တင့်သော စျေးနှုန်းဖြင့် ပေးဆောင်နေပါသည်။ အကန့်အသတ်မရှိ ပြင်ဆင်မှုများဖြင့် အရည်အသွေးကို အာမခံပါသည်။ ထို့ကြောင့် အကောင်းဆုံး ဒီဇိုင်းကို ရရှိနိုင်ပါသည်။",
